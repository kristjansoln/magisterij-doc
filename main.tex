...
\chapter{Eksperimenti in rezultati} \label{sct:eir}
    ...
    V tem poglavju predstavimo eksperimentalni del naloge in dobljene rezultate. V
    odseku~\ref{sct:eir-podatkovnazbirka}
    opišemo uporabljeno podatkovno zbirko
    FoodSeg103 in njeno poenostavljeno različico, v odseku~\ref{sct:eir-metrike}
    pa predstavimo izbrane metrike. V
    odsekih~\ref{sct:eir-eksperimenti}
    in~\ref{sct:rezultati}
    nato podamo zasnovo eksperimentov ter rezultate za
    modele FOMO, YOLOv11-seg in SAM.
    ...
    \section{Eksperimenti} \label{sct:eir-eksperimenti}
        ...
        \subsection{Model FOMO} \label{sct:eksperimenti-fomo}
            ...
            V tem odseku primerjamo dve strategiji učenja: učenje po celotnem
            modelu in učenje z zamrznjenim izluščevalnikom značilk. Obe izvedbi
            inicializiramo z utežmi, prednaučenimi na ImageNet. Namen tega
            eksperimenta je ugotoviti, v kolikšni meri lahko izvedemo prenos
            znanja. Ker ta zbirka le omejeno pokriva živila in sestavine, je
            vprašanje tudi, kolikšen del prenesenega znanja je v tej domeni
            dejansko uporaben.

            Prva strategija je učenje celotnega modela (\emph{end-to-end}),
            kjer vse plasti fino prilagodimo na ciljni podatkovni zbirki. Druga
            strategija je učenje z zamrznjenim izluščevalnikom značilk, pri
            čemer učimo samo glavo modela, izluščevalnik značilk pa ohranimo
            nespremenjen (angl. \textit{transfer learning}). Slednji pristop
            praviloma bolje ohrani prednaučeno znanje.
            ...
            %Namen in zasnova
            Namen tega eksperimenta je preveriti, ali pristop s
            ...
            razpoznava več razredov. Izbran je pristop na ravni razredov: za
            ...
            Za učenje posameznega enorazrednega modela smo morali pripraviti podatkovno zbirko, da je vsebovala zgolj dva razreda - ciljni razred ter razred ozadja.
            Kot omenjeno v poglavju~\ref{sct:eir-podatkovnazbirka-poenostavitev}, je to mogoče na več načinov. Kot izhodišče smo uporabili poenostavljeno zbirko s 30 razredi. Vsakemu vzorcu smo nato masko priredili tako, 
            da je vsebovala le ciljni razred, preostali razredi pa so bili označeni kot ozadje.
            %\paragraph{Referenca}
    ...
    \section{Rezultati} \label{sct:rezultati}
        ...
        \subsection{Model FOMO}
            ...
            % TODO: Mogoče za v zaključek al pa v diskusijo: mogoče bi bil tu bolj primeren kak drug način uteževanja, ki lahko bolj ustrezno uteži zelo redke razrede.
            ...
            Na grafih je razvidno, da validacijski krivulji po začetnem padcu v
            ...
            izvirni podatkovni zbirki
            je model dosegel izboljšanje v doseženih metrikah - mIoU smo izboljšali za $11{,}6$ oziroma $13{,}7$ odstotnih
            točk, metriko $F1_r$ pa za $24{,}3$ oz. $25{,}7$ odstotnih točk.
            Razlika med posameznima pristopoma uteževanja vzorcev znaša med $0{,}4$ in $1{,}0$ odstotno točko.
            ...
            Razvidno je, da učenje celotnega modela doseže boljše rezultate v
            ...
            % TODO:
            % Izboljšanje v metriki F1$_p$ je precej zanemarljivo, v
            % nekaterih primerih pa se ta celo poslabša.
            ...
            odstotka.
            % TODO: Diskusija
            % Ta metrika je bolj relevantna za naš primer.
            % Najslabše rešen razred malo izboljša metriko v primerjavi z
            % F1$_p$  in referenco, medtem ko preostalima razredoma metrika
            % pade.
            %
            % Overall je iz rezultatov je razvidno, da specializirani modeli ne
            % presežejo referenčne izvedbe. % Kaj to pomeni? Zakaj? Mogoče je
...
\chapter{Diskusija} \label{sct:diskusija}
    ...
    \section{Kvantizacija in izvedba na mikrokrmilnikih}
        ...
        Med dodatnimi eksperimenti smo opazili tudi, da STM32Cube.AI MCU zahteva manj pomnilnika kot TFLite Micro. Za \(\alpha=0{,}35\) se velikost kvantiziranega modela povečajo z \(236\,\mathrm{kB}\) na \(405\,\mathrm{kB}\), ko namesto okolja STM32Cube.AI uporabimo TFLite Micro. To nakazuje, da optimizacije na platformi STM32  dobro izkoristijo ciljno strojno opremo in da TFLite Micro kljub svoji splošni razširjenosti ni nujno najboljša izbira na platformi STM32.
