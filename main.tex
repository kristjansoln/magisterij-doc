...
\chapter{Uvod} \label{sct:uvod}
    ...
    Z izbrano rešitvijo smo dosegli zgolj omejene rezultate. Metoda FOMO je pomanjkljiva in ima težave predvsem z velikostjo receptivnega polja ter zahteva precej naknadne obdelave rezultatov. Težavo je predstavljala tudi odprta narava podatkovne zbirke in neugodna distribucija razredov, tipična za problematiko razpoznavanja sestavin hrane. Pristopi drugih avtorjev na podatkovni zbirki FoodSeg103 se večinoma ukvarjajo s semantično segmentacijo in ne ciljajo na izvajanje na mikrokrmilnikih, zaradi česar so njihove rešitve večinoma neprimerne za naš namen. Ovire, na katere smo naleteli tekom eksperimentov, kažejo, da je razpoznavanje sestavin hrane zahtevno področje, ki v mnogih pogledih še ni zadovoljivo rešeno.
