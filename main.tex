...
\chapter{Uvod} \label{sct:uvod}
    ...
    Nove tehnologije – zlasti računalniški vid na robnih napravah – lahko ta proces standardizirajo in olajšajo: zmanjšajo napake, skrajšajo čas ter razbremenijo uporabnika pri načrtovanju in izvedbi korakov. Že zgodnji poskusi nadzora peke so uporabili optične sisteme z obdelavo slik v pečici za spremljanje vizualnih značilnosti (barvni ton, teksturo, obliko) in s tem postavili temelje za samodejno vodenje procesa \cite{src:paquet2012monitoring}. V zadnjih letih so se metode globokega učenja uveljavile pri razpoznavi jedi in ocenjevanju količin, kar poganja razcvet aplikacij, ki pripravo deloma avtomatizirajo ali vsaj poenostavijo \cite{src:SEDEJ_2023, src:Nikodinovska_2024}. Razpoznava jedi je zato ključen gradnik: sistemu omogoči, da v realnem času razume, katera jed je prisotna, in na tej osnovi prilagodi naslednje korake ter pripravo naredi bolj zanesljivo in enostavno.
