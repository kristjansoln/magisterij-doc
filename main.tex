...
\chapter{Eksperimenti in rezultati} \label{sct:eksperimenti-in-rezultati}
    ...
    V tem poglavju predstavimo eksperimentalni del in dosežene rezultate. Najprej v odseku \ref{sct:rezultati-podatkovnazbirka} opišemo podatkovno zbirko FoodSeg103 ter postopek njene poenostavitve za potrebe nadaljnjih eksperimentov. V odseku \ref{sct:rezultati-fomo} predstavimo rezultate modela FOMO pri reševanju zbirke FoodSeg103, pri čemer obravnavamo vpliv različnih nastavitev modela, strategij učenja in kvantizacije. V odseku \ref{sct:rezultati-yolov11} nato opišemo rezultate modela YOLOv11-seg na zbirki FoodSeg103, ki ga uporabimo kot referenčni segmentacijski pristop za primerjavo z modelom FOMO. V odseku \ref{sct:rezultati-sam} na koncu predstavimo še eksperimente z modeli FastSAM in MobileSAM, s katerimi preverimo možnosti pretvorbe semantičnih segmentacijskih anotacij v instančne maske in detekcijske okvirje.

    \section{Podatkovna zbirka} \label{sct:rezultati-podatkovnazbirka}
        ...
        \subsection{Poenostavitev} \label{sct:foodseg103-poenostavitev}
            ...
            % 4. Koliko razredov odstranimo
            Kje v porazdelitvi torej narediti rez? Če ohranimo 30 razredov, to predstavlja 29~\% vseh razredov. Velikost zbirke se zmanjša za 60{,}4~\%, na skupno $2815$ vzorcev. Povprečno število vzorcev na razred postane $323 \pm 189$. Iz porazdelitve na sliki~\ref{fig:class_freq_30} je razvidno, da je najmanj zastopan razred prisoten na $79$ slikah, najbolj zastopan pa na $705$.
            
            Če ohranimo zgolj 20 razredov, to je 19~\% vseh razredov, velikost zbirke pade za 77~\% na $1634$ vzorcev. Povprečno število vzorcev na razred tako znaša $261 \pm 108$. Iz porazdelitve na sliki~\ref{fig:class_freq_20} je razvidno, da je najmanj zastopan razred prisoten na $122$ slikah, najbolj zastopan pa na $481$.
    ...
    \section{FOMO} \label{sct:rezultati-fomo}
    ...
    \section{YOLOv11n-seg} \label{sct:rezultati-yolov11}
    ...
    \section{SAM} \label{sct:rezultati-sam}
